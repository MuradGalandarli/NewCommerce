...
namespace NewCommerce.Application.Features.Commands.AppUser.FacebookLogin
{
    public class FacebookLoginCommandHandler : IRequestHandler<FacebookLoginCommandRequest, FacebookLoginCommandResponse>
    {
        ...
        public FacebookLoginCommandHandler(UserManager<Domain.Identity.AppUser> userManager,
        ...
        {
            string accessTokenResponse = await _httpClient.GetStringAsync($"https://graph.facebook.com/oauth/access_token?client_id=1384873642924462&client_secret=30292e3f609c43134544926efd9ae411&grant_type=client_credentials");
