...
namespace ETicaretAPI.Persistence.Services
{
    public class BasketService : IBasketService
    {
        ...
        {
            BasketItem? basketItem = await _basketItemReadRepository.GetById(basketItemId);
            if (basketItem != null)
            {
        ...
        {
            BasketItem? _basketItem = await _basketItemReadRepository.GetById(basketItem.BasketItemId);
            if (_basketItem != null)
            {
